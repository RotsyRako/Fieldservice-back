import { RecognizeImageGeminiRepository } from "../../repository/remote/recognizeImageGemini.repository";
 ...
 */
export class RecognizeImageGeminiService {
  private recognizeImageGeminiRepository: RecognizeImageGeminiRepository;
  ...
  constructor() {
    this.recognizeImageGeminiRepository = new RecognizeImageGeminiRepository();
  }
   ...
   */
  private handleGeminiError(error: any): ServiceResponse {
