...
import { recognizeImageController } from "../controller/recognizeImage.controller";
...
router.post(
  "/recognize-image",
  authenticateToken,
  recognizeImageController.recognizeImage
);
...
router.post(
  ...
  recognizeImageController.recognizeImageUpload
);
