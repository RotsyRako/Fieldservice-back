...
exports.EstimateInterventionRepository = void 0;
const generative_ai_1 = require("@google/generative-ai");
/**
 * Repository pour l'estimation d'intervention avec Gemini Pro
 */
class EstimateInterventionRepository {
    constructor() {
        const apiKey = process.env.GEMINI_KEY;
        if (!apiKey) {
            throw new Error("GEMINI_KEY n'est pas définie dans les variables d'environnement.\n" +
        ...
        try {
            ...
            throw new Error(`Impossible d'initialiser Gemini: ${error.message}`);
        }
    }
    /**
     ...
     */
    async estimateInterventionTime(interventionData) {
        try {
  ...
  "confidence": <nombre entre 0 et 1 indiquant ton niveau de confiance>
    ...
    parseGeminiResponse(text) {
        try {
            ...
            throw new Error(`Impossible de parser la réponse de Gemini: ${error.message}\nRéponse reçue: ${text.substring(0, 200)}`);
        }
    }
    /**
     ...
     */
    convertHoursToTimeFormat(hours) {
...
exports.EstimateInterventionRepository = EstimateInterventionRepository;
