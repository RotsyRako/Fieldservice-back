...
exports.RecognizeImageRepository = void 0;
 ...
 */
class RecognizeImageRepository {
    constructor() {
        ...
        if (!fs.existsSync(credentialsPath)) {
            throw new Error(`Fichier de credentials Google Cloud non trouvé: ${credentialsPath}\n` +
        ...
        try {
            ...
            throw new Error(`Impossible d'initialiser Google Cloud Vision API avec le fichier: ${credentialsPath}\n` +
    ...
    async detectObjects(imageBuffer) {
        try {
            ...
            if (!this.client.objectLocalization) {
                throw new Error("La méthode objectLocalization n'est pas disponible. " +
...
exports.RecognizeImageRepository = RecognizeImageRepository;
