...
const recognizeImageGemini_controller_1 = require("../controller/recognizeImageGemini.controller");
...
router.post("/recognize-image-gemini", auth_1.authenticateToken, recognizeImageGemini_controller_1.recognizeImageGeminiController.recognizeImage);
...
router.post("/recognize-image-gemini-upload", auth_1.authenticateToken, (req, res, next) => {
...
}, recognizeImageGemini_controller_1.recognizeImageGeminiController.recognizeImageUpload);
