...
exports.EstimateInterventionService = void 0;
const estimateIntervention_repository_1 = require("../../repository/remote/estimateIntervention.repository");
 ...
 */
class EstimateInterventionService {
    constructor() {
        this.estimateInterventionRepository = new estimateIntervention_repository_1.EstimateInterventionRepository();
    }
    /**
     ...
     */
    async estimateInterventionTime(interventionId) {
        try {
            ...
            const estimation = await this.estimateInterventionRepository.estimateInterventionTime(interventionData);
            return {
                success: true,
                data: estimation,
     ...
     */
    async getInterventionCompleteData(interventionId) {
        try {
            const intervention = await prisma_1.prisma.intervention.findUnique({
...
exports.EstimateInterventionService = EstimateInterventionService;
